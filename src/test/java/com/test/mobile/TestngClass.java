...
//          AndroidDriver driver = new AndroidDriver(URL, caps);
			...
			driver.findElement(By.id("in.swiggy.android:id/tv_phone_umber")).sendKeys("8310535144");
			driver.findElement(By.id("in.swiggy.android:id/full_width_button_label")).click();
...
//        String attribute = x.getAttribute("text");
		...
		String[] lst1 = { "Dindigul Thalappakatti", "Meghana Foods", "Hyderabad Biryaani House", "Nandhana Palace","Paradise Biryani",
...
//WebElement element = driver.findElement(By.xpath("Prawns Biryani']"));
		WebElement element = driver.findElement(By.xpath("//android.widget.TextView[@text='Meghana Special Biryani']"));
...
// TODO Auto-generated method stub
		touchAction.longPress(LongPressOptions.longPressOptions().withPosition(PointOption.point(x, y)))
		...
		String PriceafterAddToCart = driver.findElement(By.xpath("(//android.widget.TextView[@content-desc=\"price ₹299 rupees\"])[1]")).getAttribute("text");
